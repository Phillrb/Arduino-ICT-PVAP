...
//THESE ARE THE VALUES SUGGESTED BY PAUL SWAN
...
//THESE ARE THE VALUES I'VE FOUND TO WORK ON MY SAINSMART LCD SHIELD 

	static int RIGHTKEY_ARV = 0;
	static int UPKEY_ARV	= 140;
	static int DOWNKEY_ARV	= 324;
	static int LEFTKEY_ARV	= 500;
	static int SELKEY_ARV	= 738;
	static int NOKEY_ARV	= 1023;
